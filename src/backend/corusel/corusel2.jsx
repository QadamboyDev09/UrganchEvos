...
const Corusel2 = () => {
  ...
  const url ='https://ce1a1e26cf80d56c.mokky.dev/corusel2'
    ...
    <div className="grid gap-[40px] ">
      {data.map((product) => (
        <div key={product.id}>
            ...
            <div className='rounded-t-3xl items-center flex justify-center'>
             <div className="w-[500px]  grid-cols-2  items-center py-[100px] gap-[30px] hidden lg:grid">
             <img className="w-[300px] h-[250px]" src={product.img1} alt="" />
             <img className="w-[300px] h-[250px]" src={product.img2} alt="" />
             <img className="w-[300px] h-[250px]" src={product.img3} alt="" />
             <img className="w-[300px] h-[250px]" src={product.img4} alt="" />
             </div>
            </div>
