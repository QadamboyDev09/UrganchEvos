        ...
        <div key={product.id}>
          <div className='flex gap-10 flex-col lg:flex-row'>
            < div className='w-full h-full leading-[40px]'>
              <h1 className='text-white  font-bold w-[320px] pt-[40px] text-[20px] lg:text-[40px] sm:text-[30px] lg:w-[650px]  '>{product.title}</h1>
              <div className='flex gap-4 py-[40px] '>
                <button className='text-white text-[22px] lg:text-[32px]' ><FaBitbucket /></button>
                <button className='text-white text-[22px] lg:text-[32px]'><FaHamburger /></button>
                <button className='text-white text-[22px] lg:text-[32px]'><FaHotdog /></button>
                <button className='text-white text-[22px] lg:text-[32px]'><PiHamburgerFill /></button>
                <button className='text-white text-[22px] lg:text-[32px]'><PiWaveformBold /></button>
              </div>
              <div>
              ...
              <Link to={'/imglink'}>
                <div  className="w-full  py-[100px] h-full hidden lg:flex">
