      ...
      <div key={product.id}>
        <div className='flex gap-10 flex-col lg:flex-row'>
          < div className='w-full h-full leading-[40px] py-[100px]'>
            {/* <h1 className='text-white text-[40px] font-bold w-[650px] pt-[40px]'>{product.title}</h1> */}
            ...
            <div>
            {/* <h2 className='text-white text-[23px] w-[600px] '> {product.text}</h2> */}
            </div>
