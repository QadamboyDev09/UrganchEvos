...
const Burgerlar = () => {
  ...
  const url = "https://ce1a1e26cf80d56c.mokky.dev/cardsburgerlar";
  ...
  return (
    <div id="burgerlar" className="bg-[#F6F8F9]">
      <div className="container mx-auto ">
        <h1 className="text-[40px] font-bold ">Burgerlar</h1>
        <div className="w-full h-full flex justify-center items-center rounded-xl px-4 bg-white sticky top-0 "></div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ">
          ...
          "
              key={product.id}
            >
              <div onClick={() => navigate(`/burgerlar/${product.id}`)}>
                <img
