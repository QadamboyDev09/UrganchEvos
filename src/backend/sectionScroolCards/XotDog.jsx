...
const XotDog = () => {
  ...
  const url = "https://ce1a1e26cf80d56c.mokky.dev/cardsxotdog";
  ...
  return (
    <div id="xotdog" className="bg-[#F6F8F9]">
      <div className="container mx-auto ">
        <h1 className="text-[40px] font-bold ">Xot Dog</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ">
          ...
          "
              key={product.id}
            >
              <div onClick={() => navigate(`/xotdog/${product.id}`)}>
                <img
